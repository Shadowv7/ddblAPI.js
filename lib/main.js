...
async getBotID(id) {
  ...
  return new Promise((resolve, reject) => {
         ...
         http.get(pageURL.replace("{id}", id), (res) => {
            ...
            if (statusCode !== 200) {
               ...
               reject(`[divinedblAPI][GET] An error has occurred: ${statusCode}`);
            ...
            res.on('end', () => {
                ...
                try {
                  ...
                  console.log(results);
                    ...
                    reject(`[divinedblAPI][GET] An error has occurred: ${e.message}`);

                }

            }).on('error', (err) => {

                reject(`[divinedblAPI][GET] An error has occurred: ${err.message}`);
